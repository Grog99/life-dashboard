    ...
    <div className="auth-shell">
      ...
      <main className="auth-card">
        ...
        <form onSubmit={submit}>
          ...
          <label className="field"><span>Hasło</span><input required minLength={12} type="password" value={password} onChange={(event) => setPassword(event.target.value)} autoComplete={mode === "login" ? "current-password" : "new-password"} /><small>Minimum 12 znaków</small></label>
