...
const accountTypeMeta: Record<FinanceAccount["type"], { label: string; icon: typeof Wallet }> = {
    ...
    <div className="finance-page page-enter">
      ...
      <section className="finance-summary-grid" aria-label="Podsumowanie finansów">
        ...
        <article className="finance-summary-card">
          <div className="finance-summary-card__top">
            ...
            <span>
              {primaryBudgets.length
                ? `${overBudgetCategories.length}/${primaryBudgets.length}`
                : "—"}
            </span>
          </div>
      ...
      <section className="panel finance-accounts-panel">
        <header className="panel__header panel__header--compact finance-section-heading">
          ...
          <button className="text-button" type="button" onClick={() => setAccountModalOpen(true)}>
                ...
                >
                  <div className="finance-budget-row__heading">
                    ...
                    <span>
                      ...
                      <small>
                        / {formatMoney(budget.limitMinor, budget.currency, hideAmounts)}
                      </small>
                    </span>
                  </div>
                  <div
        ...
        <section className="panel finance-goals-panel">
          ...
          <div className="finance-goal-list">
            {savingsGoals.map((goal, index) => {
              const progress =
                goal.targetMinor > 0 ? (goal.savedMinor / goal.targetMinor) * 100 : 0;
      ...
      >
        <form className="finance-form" onSubmit={handleAddTransaction}>
          <div className="finance-direction-switch" role="group" aria-label="Rodzaj transakcji">
            <button
              className={transactionForm.direction === "expense" ? "active" : ""}
              type="button"
              onClick={() => setTransactionForm((form) => ({ ...form, direction: "expense" }))}
            >
              <ArrowUpRight size={16} /> Wydatek
            </button>
            <button
              className={transactionForm.direction === "income" ? "active" : ""}
              type="button"
              onClick={() => setTransactionForm((form) => ({ ...form, direction: "income" }))}
            >
          ...
          <div className="form-grid form-grid--2">
              ...
              <select
                ...
                onChange={(event) => {
                  ...
                  setTransactionForm((form) => ({
                    ...
                    visibility: account?.visibility ?? form.visibility,
                  }));
                }}
              >
            ...
            <label className="field">
              ...
              <input
                required
                type="date"
                value={transactionForm.bookedOn}
                onChange={(event) =>
                  setTransactionForm((form) => ({ ...form, bookedOn: event.target.value }))
                }
              />
            </label>
          </div>
          ...
          <div className="form-grid form-grid--2">
            ...
            <label className="field">
              ...
              <select
                value={transactionForm.visibility}
                onChange={(event) =>
                  setTransactionForm((form) => ({
                    ...form,
          ...
          <label className="field">
            ...
            <textarea
              ...
              onChange={(event) =>
                setTransactionForm((form) => ({ ...form, notes: event.target.value }))
              }
            />
          </label>
            ...
            <label className="field finance-color-field">
              ...
              <div>
                <input
                  ...
                  onChange={(event) =>
                    setAccountForm((form) => ({ ...form, color: event.target.value }))
                  }
                />
                <span>{accountForm.color.toUpperCase()}</span>
              </div>
            </label>
          </div>
          <div className="modal-actions">
          ...
          <div className="form-grid form-grid--2">
            ...
            <label className="field">
              ...
              <select
                ...
                onChange={(event) =>
                  setBudgetForm({ ...budgetForm, currency: event.target.value as CurrencyCode })
                }
              >
                {currencyOptions.map((currency) => (
                  <option key={currency}>{currency}</option>
          ...
          <label className="field finance-color-field">
            ...
            <div>
              <input
                ...
                onChange={(event) => setBudgetForm({ ...budgetForm, color: event.target.value })}
              />
              <span>{budgetForm.color.toUpperCase()}</span>
            </div>
          </label>
          <div className="modal-actions">
            <span />
        ...
        <form className="finance-form" onSubmit={saveGoal}>
          ...
          <div className="form-grid form-grid--2">
            ...
            <label className="field">
              ...
              <input
                ...
                onChange={(event) => setGoalForm({ ...goalForm, saved: event.target.value })}
                placeholder="0,00"
              />
            </label>
          </div>
          <div className="form-grid form-grid--2">
            <label className="field">
              ...
              <select
                ...
                onChange={(event) =>
                  setGoalForm({ ...goalForm, currency: event.target.value as CurrencyCode })
                }
              >
                {currencyOptions.map((currency) => (
                  <option key={currency}>{currency}</option>
          ...
          <label className="field">
            ...
            <select
              ...
              onChange={(event) =>
                setGoalForm({ ...goalForm, visibility: event.target.value as Visibility })
              }
            >
              <option value="private">Tylko ja</option>
        ...
        {!csvPreview ? (
          ...
          <div className="finance-import-review">
            <div className="finance-import-filebar">
              ...
              <div>
                ...
                <span>
                  ...
                  {csvPreview.delimiter === "\t" ? "tabulator" : `„${csvPreview.delimiter}”`} ·
                  kodowanie {csvEncoding ?? "UTF-8"}
                </span>
              </div>
              <button
              ...
              <div className="finance-mapping-grid">
                <label className="field">
                  ...
                  <select
                    ...
                    onChange={(event) => updateCsvMapping("dateColumn", event.target.value)}
                  >
                ...
                <label className="field">
                  ...
                  <select
                    ...
                    onChange={(event) =>
                      updateCsvMapping("dateFormat", event.target.value as CsvMapping["dateFormat"])
                    }
                  >
                ...
                <label className="field">
                  ...
                  <select
                    ...
                    onChange={(event) => updateCsvMapping("amountColumn", event.target.value)}
                  >
                    {csvPreview.headers.map((header) => (
                      <option key={header}>{header}</option>
                    ))}
                ...
                <label className="field">
                  ...
                  <select
                    ...
                    onChange={(event) => updateCsvMapping("titleColumn", event.target.value)}
                  >
                    {csvPreview.headers.map((header) => (
                      <option key={header}>{header}</option>
                    ))}
                ...
                <label className="field">
                  ...
                  <select
                    ...
                    onChange={(event) =>
                      updateCsvMapping("merchantColumn", event.target.value || undefined)
                    }
                  >
                ...
                <label className="field">
                  ...
                  <select
                    ...
                    onChange={(event) =>
                      updateCsvMapping("categoryColumn", event.target.value || undefined)
                    }
                  >
              ...
              <div className="finance-import-preview">
                  ...
                  <tbody>
                    {csvRowsWithStatus.slice(0, 50).map(({ transaction, duplicate }, index) => (
                      ...
                      >
                        <td>
                          <span
                            className={`finance-import-status${duplicate ? " is-duplicate" : ""}`}
                          >
                ...
                {csvRowsWithStatus.length > 50 && (
                  <p className="finance-form-hint">
                    Podgląd pokazuje pierwsze 50 z {csvRowsWithStatus.length} poprawnych operacji.
                    Import obejmie wszystkie.
                  </p>
                )}
              </div>
            ) : (
            ...
            <div className="modal-actions finance-import-actions">
              ...
              <div>
                <button className="button button--ghost" type="button" onClick={closeImportModal}>
                  Anuluj
                </button>
                <button
                  className="button button--primary"
